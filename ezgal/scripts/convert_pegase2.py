...
seds /= (4.0*math.pi*ezgal.utils.convert_length( 10, incoming='pc', outgoing='cm' )**2.0)
...
ages_hdu = pyfits.new_table(pyfits.ColDefs( [pyfits.Column(name='ages', array=info['age']*1e6, format='D', unit='years'), pyfits.Column(name='masses', array=info['mstars'] + info['mwd'] + info['mbhns'], format='D', unit='m_sun')] ))
